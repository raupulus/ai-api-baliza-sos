...
# ---------------------------------------------------------------------------
# Máximo de bytes UTF-8 por mensaje (200 bytes reales disponibles en clientes LoRa/Meshtastic).
RESP_MAX_BYTES_PER_MSG = int(os.environ.get("RESP_MAX_BYTES_PER_MSG", "200"))
...
UPDATER_USER_AGENT = os.environ.get(
    "UPDATER_USER_AGENT",
    "bot-ia-auxiliar/0.1 (+contacto: public@raupulus.dev)",
)
