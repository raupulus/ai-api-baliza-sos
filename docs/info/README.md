# docs/info — Documentación técnica

1. `01-vision-requisitos.md` — Visión, casos de uso, requisitos.
2. `02-arquitectura.md` — Arquitectura de los dos servicios e infraestructura.
